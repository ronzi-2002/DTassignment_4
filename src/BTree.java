...
public class BTree<T extends Comparable<T>> {
    ...
    protected Deque<List<T>> lastOneEnter;
    ...
    public BTree() {
        this(2);
        this.lastOneEnter= new LinkedList<List<T>>();
    }
    ...
    public void insert(T value) {
        ...
        list.add(value);
        this.lastOneEnter.addFirst(list);
        if (root == null) {
            ...
            while (currentNode != null && !wasAdded) {
                ...
                if (currentNode.getNumberOfKeys() == maxDegree - 1) {
                    this.lastOneEnter.peekFirst().add(currentNode.getKey((maxDegree-1)/2));
                    split(currentNode);
